...
# # # Ours
# python scripts/hab2_bench/hab2_benchmark.py --cfg benchmark/rearrange/rearrange_easy.yaml --n-steps "$NUM_STEPS" --n-procs "1" --out-name "all_1"

# # # Ours (-Concur Render)
python scripts/hab2_bench/hab2_benchmark.py --cfg benchmark/rearrange/place.yaml --n-steps "$NUM_STEPS" --n-procs "1" --out-name "noconcur_1" "$NO_CONCUR"

# # Ours (-Auto sleep)
# python scripts/hab2_bench/hab2_benchmark.py --cfg benchmark/rearrange/rearrange_easy.yaml --n-steps "$NUM_STEPS" --n-procs "1" --out-name "nosleep_$i" "$NO_SLEEP"
